...
type (
	// Styles tracks lxz styling options.
	Styles struct {
		LXZ       Style `json:"lxz" yaml:"lxz"`
		listeners []StyleListener
	}

	// Style tracks lxz styles.
	Style struct {
...
func (s *Styles) Table() Table {
	return s.LXZ.Views.Table
}

// Xray returns xray styles.
func (s *Styles) Xray() Xray {
	return s.LXZ.Views.Xray
}
...
func (s *Styles) Update() {
	...
	tview.Styles.BorderColor = s.LXZ.Frame.Border.FgColor.Color()
